...
<head>
  ...
  <title>Ship Chandling & Logistic Service - JubisLogistics</title>
...
<div class="sidebar">
 ...
 <div class="search-form-wrapper">
  ...
  <!-- partial:partia/__subheader -->
  <div class="sigma_subheader dark-overlay" style="background-image: url(assets/img/subheader.jpg)">

    <div class="container">
      <div class="sigma_subheader-inner">
        <div class="sigma_subheader-text">
          <h1>Ship Chandling & Log. Service</h1>
        </div>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a class="btn-link" href=".">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Ship Chandline</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-lg-6 mb-lg-30">
          <div class="section-title mb-0 text-left">
            <p class="subtitle"> <span></span>Ship Chandling and Logistic Service <span></span> </p>
            <div class="col-lg-6">
              <img src="assets/img/about2.jpg" alt="about">
            </div>
           </div>
<ul>
    <li>Ship food and beverages supplies</li>
    <li>Engine spare parts supplies</li>
    <li>Personal protective equipment & supplies</li>
    <li>Ship stationeries and publica􀆟on supplies</li>
    <li>Marine lubricant</li>
    <li>Electrical & electronic fitting tools supplies</li>
    <li>Plumbing fitting & tools supplies</li>
    <li>Floating & acetylene gases supplies</li>
    <li>Fire fighting equipment supplies</li>
    <li>Fenders & bouys supplies</li>
    <li>Fresh water & burner supplies</li>
    <li>Marine ropes</li>
    <li>Anchor & anchor chain supplies</li>
    <li>Every other consumable supplies on deck, engine room and bridge or marine paints & accessories</li>
</ul>
</div>
