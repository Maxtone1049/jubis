...
<head>
  ...
  <title>Logistics - JubisLogistics</title>
 ...
 <!-- About Start -->
  <section class="section">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 mb-lg-30">
          <div class="section-title mb-0 text-left">
            <p class="subtitle"> <span></span> Road Freight<span></span> </p>
            <div class="col-lg-6">
    ...
    Our Team of well Experience personnel are spread across the geopolitical zones of Nigeria to take request from our clients to pick up their goods from the point of departure to the point of destination through the road route. <br>
              ...
              <br>
              Movement of mini, micro and macro goods from any part in Nigeria to any area in Nigeria
          </p>
</div>
<div class="col-lg-6 mb-lg-30">
    <div class="section-title mb-0 text-left">
      <p class="subtitle"> <span></span> Air Frieght <span></span> </p>
      <div class="col-lg-6">
        <img src="assets/img/air.png" alt="about">
      </div>
     </div>
     <p style="text-align: justify;">
