...
<head>
  ...
  <title>Technical Services - JubisLogistics</title>
      ...
      <div class="sigma_subheader-inner">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Technical Services</li>
          </ol>
        </nav>
      </div>
    </div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="sigma_service style-1">
              <div class="sigma_service-thumb">
                <img src="assets/img/part.jpg" style="border-radius: 50px;width: 90px;height: 90px; object-fit: cover;" alt="">
              </div>
